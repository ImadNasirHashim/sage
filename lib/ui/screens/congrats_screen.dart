...
import 'package:sage/ui/screens/home.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Stack(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: 38.0, vertical: 25),
                    child: Text(
            ...
            CustomNextButton(
              ...
              height: 48.h,
              width: 180.w,
              onPressed: () => Navigator.pushReplacement(context, CustomPageRoute(child: Home())),
                  // Get.offAll(() => Home()
                  // HomeScreen()
            ),
          ],
